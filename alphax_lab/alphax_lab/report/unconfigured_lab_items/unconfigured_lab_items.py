...
Two failure modes are reported:
    ...
    no Lab Test Consumption record     mapped, but nothing is defined to consume
"""
...
def execute(filters=None):
	...
	for item in items:
		if item.name not in mapped:
			...
			issue = _("No active Lab Test Consumption record")
			fix = _("Create a Lab Test Consumption record listing what this test consumes")
		else:
			continue
