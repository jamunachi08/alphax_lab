...
**On the test Item.** Open the item, find the collapsed **Lab Consumables**
section under Item Group.
...
Defining consumption on the Item also keeps it correct if a second sales channel
appears later, such as walk-in POS. It attaches to what is sold, not to how one
external system happens to name it.
